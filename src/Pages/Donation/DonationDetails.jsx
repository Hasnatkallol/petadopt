  ...
  return (
    <div className="flex flex-col items-center justify-center bg-gray-50 px-4 py-10">
      ...
      <div className="w-full max-w-4xl p-6 rounded-2xl bg-white shadow-xl border border-gray-200 transition-all duration-300 hover:shadow-2xl mb-10">
        <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center">Donation Details</h2>
        ...
        <div className="flex  flex-col md:flex-row md:justify-around items-center gap-6">
          ...
          <div className=" space-y-3">
            ...
            <p className="text-gray-600 leading-relaxed">{description?.slice(0, 120)}...</p>
            ...
            <div className="text-sm text-gray-700 space-y-2">
              ...
              <p>
                <span className="font-medium text-gray-800">Donated:</span> ${donatedAmount || 0}
              </p>
              <p>
                <span className="font-medium text-gray-800">Goal:</span> ${maximumDonationAmount || "N/A"}
              </p>
            </div>
          </div>
        </div>
      ...
      {showModal && (
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-40">
          <div className="relative flex flex-col items-center max-w-lg w-full gap-5 p-8 rounded-2xl shadow-xl sm:py-10 sm:px-12 bg-white text-gray-900">
            ...
            <h2 className="text-2xl font-semibold text-center">Donate to {petName}</h2>
            ...
            <form onSubmit={handleSubmit} className="w-full flex flex-col gap-4">
              ...
              <div>
                ...
                <div className="w-full border rounded-lg p-4 text-center bg-gray-100 text-gray-500">
              ...
              <button
                type="submit"
                className="w-full px-4 py-3 mt-4 font-semibold text-white bg-green-600 rounded-lg hover:bg-green-700 transition-all duration-300"
              >
                Donate Now
              </button>
            </form>
